...
-- Enhanced documents table with vector support
...
-- Document relationships with vector similarity
...
-- Smart reminders with AI scheduling
...
CREATE TABLE public.analytics (
    ...
    UNIQUE(user_id, type, period, DATE(generated_at))
);
...
CREATE INDEX idx_documents_vector ON public.documents USING ivfflat (vector_embedding vector_cosine_ops);
CREATE INDEX idx_documents_text_search ON public.documents USING gin(to_tsvector('english', extracted_text));
